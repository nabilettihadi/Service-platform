    ...
    <div class="container mx-auto p-8">
        ...
        <div class="mb-4 text-right">
            <a href="{{ route('services.create') }}"
                class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Créer un Service</a>
        </div>
        @endif
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                <img src="{{ asset('services.webp') }}" alt="{{ $service->title }}"
                ...
                <div class="p-6">
                    ...
                    <a href="{{ route('services.show', $service->id) }}" class="text-blue-300 hover:underline">Voir les
                        détails</a>
