    ...
    <div class="container mx-auto p-8">
        ...
        @if(auth()->check())
            <div class="mb-4 text-right">
                <a href="{{ route('services.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Créer un Service</a>
            </div>
        @endif
                    ...
                    <div class="p-6">
                        ...
                        @if(auth()->check() && $service->user_id == auth()->user()->id)
                            <div class="mt-4 flex justify-end space-x-2">
                                <a href="{{ route('services.edit', $service->id) }}" class="text-yellow-500 hover:text-yellow-700">Modifier</a>
